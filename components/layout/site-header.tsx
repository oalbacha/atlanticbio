...
export function SiteHeader() {
  ...
  const activeLabel = useMemo(() => {
    return navItems.find((item) => isActivePath(item.href, pathname))?.label ?? "Home"
  }, [pathname])
      ...
      <div className="mx-auto flex h-18 w-full max-w-7xl items-center justify-between px-6 lg:px-8">
        ...
        <Dialog open={open} onOpenChange={setOpen}>
          ...
          <DialogContent
            ...
            className="inset-0 top-0 left-0 h-[100dvh] max-w-none translate-x-0 translate-y-0 rounded-none border-0 bg-background/97 p-0"
          >
            ...
            <div className="flex h-full flex-col">
              <div className="flex items-center justify-between border-b border-border/70 px-6 py-5">
                <p className="font-heading text-lg tracking-[0.1em] uppercase">Menu</p>
